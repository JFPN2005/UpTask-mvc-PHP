(function() {
        ...
        modal.innerHTML = `
            <form class="formulario nueva-tarea">
                ...
                <div class="opciones">
                    ...
                    />
                    <button type="submit" class="cerrar-modal">Cancelar</button>
                </div>
            </form>
        `;
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        // Previene la creacio de multiples alertas
        ...
        // Eliminar la alertas despues de 5 segundos
        setTimeout(() => {
            alerta.remove();
        }, 5000);
    }
    ...
    async function agregarTarea(tarea) {
        ...
        try {
            ...
            if(resultado.tipo === 'exito') {
                ...
                // Agregar el objeto de tarea al grobal de tareas
                const tareaObj = {
